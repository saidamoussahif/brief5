    ...
    <div class="section">
        <div class="booking-form">
            <div class="booking-title">
                <h3>Search your trip with booking system</h3>
            </div>
            <form action="http://localhost/brief_MVC/booking/Research" method="POST">
                ...
                <div class="search"> <button class="btn" type="submit" name="submit">Search</button>
                </div>
            </form>
        </div>
    </div>
                                    ...
                                    <tbody>
                                        <?php foreach ($_SESSION['ID_voyage'] as $onevoyage) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="/brief_MVC/view/booking" method="post"><button name="ID_voyage" value="<?php echo $onevoyage["ID_voyage"]; ?>" class="btn btn-warning">Book now</button></form>
                                                </td>
